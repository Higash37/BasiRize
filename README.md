...
[math²ドリルを使ってみる](https://basirise.com/)
...
そこで、講師が生徒の状況に合わせて、同じレベルの問題を繰り返し用意できるようにするため、math²ドリルを作りました。
...
math²ドリルを使えば、教材から基礎問題ページを探して印刷するのではなく、速ければ15秒以内に印刷可能です。
...
math²ドリルは、TypeScriptとReactで作ったクライアントサイドアプリケーションです。
