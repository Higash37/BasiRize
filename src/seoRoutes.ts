...
const LEVEL_SEO_CONTENT: Record<Level, LevelSeoContent> = {
  小学校: {
    ...
    description:
      "小学1年生から6年生までの算数問題プリントを単元別に無料作成。たし算、ひき算、かけ算、わり算、分数、小数、図形などを選び、解答付きで印刷できます。",
  ...
  中学校: {
    ...
    description:
      "中学1年生から3年生までの数学問題プリントを単元別に無料作成。正負の数、方程式、関数、図形、確率などを選び、解答付きで印刷できます。",
  ...
  高校: {
    ...
    description:
      "高校数学の基礎問題プリントを単元別に無料作成。二次関数、三角比、場合の数、数列、微分・積分、ベクトルなどを選び、解答付きで印刷できます。",
